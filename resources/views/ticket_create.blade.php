        ...
        <div style="width: 900px;" class="container max-w-full mx-auto pt-4">
            <form method="POST" action="{{ route('ticket.store') }}">
                ...
                <div class="mb-4">
                    ...
                    <textarea class="h-25 bg-white border border-gray-300 rounded py-4 px-3 mr-4 w-full text-gray-600 text-sm focus:outline-none focus:border-gray-400 focus:ring-0" id="location" name="location"></textarea>
                </div>

                <button class="bg-blue-500 tracking-wide text-white px-20 py-2 inline-block mb-6 shadow-lg rounded hover:shadow">Create</button>
